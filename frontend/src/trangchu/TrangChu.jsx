      ...
      <main>
        <section id="news1">
          <article>
            <a href="">
              <b>
                Officials: Over 2,600 rescued from flooded Ukrainian-controlled
                areas of Kherson
              </b>
            </a>
            ...
            <a href="">
              <b>
                Water level at the Nova Kakhovka reservoir ‘continues to
                decline,’ minister says, after collapse of major dam in southern
                Ukraine
              </b>
            </a>
            <ul>
              <li>
                <a href="">
                  Ukrainians in battered southern town hopeful about counter
                  offensive
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="">
                  <b>Analysis:</b> What’s happening along the frontline? It’s
                  too early to tell
                </a>
              </li>
            </ul>
          ...
          <article>
            <div>
              ...
              <a href="">
                <b>
                  Trump’s chilling remarks reveal a deeper, emerging reality
              ...
              <ul>
                ...
                <li>
                  <a href="">
                    <b>Opinion:</b> Trump’s case is a crucial test for justice
                    in America
                  </a>
                </li>
              </ul>
            ...
            <div>
              ...
              <a href="">
                <b>
                  A map in India’s new Parliament is making its neighbors
                  nervous
                </b>
              </a>
            </div>
          ...
          <article className="SArticle">
            ...
            />
            <a href="">
              <b>Pittsburgh synagogue gunman found guilty on all 63 charges</b>
            </a>
            <ul>
              <li>
                <a href="">
                  Cyclist Gino Mäder dies aged 26 after high-speed Tour de
                  Suisse crash
                </a>
              </li>
              <li>
                <a href="">Thousands of dead fish wash up on Thai beach</a>
              </li>
              <li>
                <a href="">
                  <i
              ...
              <li>
                <a href="">
                  Alleged Russian diplomat squatter is just ‘some bloke standing
                  on a blade of grass’, Australian PM says
                </a>
              </li>
              <li>
                <a href="">Beijing records its hottest ever June day</a>
              </li>
              <li>
                <a href="">
                  <i
                  ...
                  ></i>
                  CNN’s Amanpour asks Obama about ‘spectacle’ of Trump. Hear his
                  answer
                </a>
              </li>
              <li>
                <a href="">
                  Teenager killed by exploding fire extinguisher during school
                  drill
                </a>
              </li>
            </ul>
        ...
        <section id="news2">
          <article className="SArticle">
            ...
            />
            <a href="#">
              <b>What scientists say keeps mosquitoes at bay</b>
            </a>
            <ul>
              <li>
                <a href="#">
                  Train derailment on Montana bridge sends multiple rail cars
                  into the Yellowstone River
                </a>
              </li>
              <li>
                <a href="#">Orca pod attacks Ocean Race boats</a>
              </li>
              <li>
                <a href="#">
                  <b>CNN Exclusive:</b> GOP fake electors given immunity as Jan.
                  6 probe heats up
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="#">
                  Tina Turner to be honored by Patti LaBelle during the BET
                  Awards on Sunday
                </a>
              </li>
              <li>
                <a href="#">
                  6 amazing facts about the deepest point known on Earth
                </a>
              </li>
            </ul>
          </article>
          ...
          <article className="SArticle">
            ...
            <ul>
              <li>
                ...
                />
                <a href="#">
                  These ordinary people became accidental stars thanks to this
                  niche video genre
                </a>
              </li>
              <li>
          ...
          <article className="SArticle">
            <ul style={{ marginTop: 0 }}>
              <li style={{ borderTop: "none", paddingTop: 0 }}>
                ...
                />
                <a href="#">
                  Meet the Ghanaian Canadian Lego sculptor building a Black
                  universe
                </a>
              </li>
              <li>
        ...
        <section id="news3">
          <article className="SArticle">
            ...
            <a href="#">
              <b>
                This endangered bird has found a refuge among Hong Kong’s
                skyscrapers
              </b>
            </a>
            <ul>
              <li>
                ...
                />
                <a href="#">
                  Fox News shuffles prime-time lineup in wake of Tucker Carlson
                  firing and sagging ratings
                </a>
              </li>
              <li>
                <img
          ...
          <article className="SArticle">
            ...
            <a href="#">
              <b>
                Lost for decades, these 19th-century photo portraits tell a
                quietly radical love story
              </b>
            </a>
            <ul>
              <li>
                <video className="vSmallImg" loop autoPlay muted>
                  <source
                    src="https://media.cnn.com/api/v1/loops/stellar/prod/desktoploop-2.mp4?q=h_422,w_752,x_0,y_0"
                    type="video/mp4"
                  />
                </video>
                <a href="#">
                  Curious whale follows kayak as Australia revels in bumper
                  annual humpback count
                </a>
              </li>
              <li>
                <img
          ...
          <article className="SArticle">
            ...
            <a href="#">
              <b>
                It’s one of the world’s oldest spirits. Now it’s making a
                comeback
              </b>
            </a>
            <ul>
              <li>
                ...
                />
                <a href="#">
                  Shot putter enjoys ‘crazy’ fame after competing in hurdles
                  event
                </a>
              </li>
              <li>
                ...
                />
                <a href="#">
                  Adam Sandler sends support to real-life Happy Gilmore
                </a>
              </li>
              <li>
                <div
        ...
        <section id="news4">
          ...
          <article className="SArticle">
            ...
            <a href="#">
              <b>
                Live updates on a huge day for the US economy: Housing, GDP,
                jobs and Bidenomics
              </b>
            </a>
            <ul>
              <li>
                <a href="#">Flight problems mostly over — except at United</a>
              </li>
              <li>
                <a href="#">
                  The Fed is secretly stress testing the US economy against
                  nightmare scenarios
                </a>
              </li>
              <li>
                <a href="#">
                  Climate event El Niño could hit the economy from food prices
                  to clothing sales this year
                </a>
              </li>
              <li>
                <a href="#">
                  Jesse Watters was invited to speak before a group of
          ...
          <article className="SArticle">
            ...
            />
            <a href="#">
              <b>The world’s biggest cruise ship is almost ready</b>
            </a>
            <ul>
              <li>
                <a href="#">
                  She stuffed a bra with clothes before boarding a plane. Here’s
                  why
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="#">
                  She delivered a baby on an airplane. Here’s what happened next
                </a>
              </li>
              <li>
                <a href="#">
                  The fire that’s ‘burned for 4,000 years and never gone out’
                </a>
              </li>
              <li>
                <a href="#">
                  Qantas reveals economy seats for 19-hour NYC-Sydney ultra
                  long-haul flights
                </a>
              </li>
            </ul>
        ...
        <section id="news5">
          <article className="SArticle">
            ...
            <a href="#" style={{ fontSize: "1.2rem" }}>
              <b>
                Caroline Wozniacki plans return to tennis at US Open three years
            ...
            <ul>
              <li>
                <a href="#">
                  Australian teenager Arisa Trew, 13, becomes first female in
                  skateboarding history to land 720 trick
                </a>
              </li>
              <li>
                <a href="#">
                  Ultra runner breaks record of world’s oldest 100-mile race by
                  almost 80 minutes
                </a>
              </li>
              <li>
                <a href="#">
                  Summer transfer window: The biggest moves so far as Saudi
                  Arabia becomes major factor
                </a>
              </li>
              <li>
                <a href="#">
                  One of the world’s fastest athletes is without a country to
                  run for
                </a>
              </li>
              <li>
                <a href="#">
                  Meet the photographer redefining how we view the world of
                  chess
                </a>
              </li>
            </ul>
          ...
          <article className="SArticle">
            ...
            <a href="#">
              <b>
                Archaeologists find a 3,000-year-old sword so well preserved
                it’s still gleaming
              </b>
            </a>
            <ul>
              <li>
                <a href="#">
                  Princess Diana’s famous ‘black sheep’ sweater is going up for
                  auction
                </a>
              </li>
              <li>
                <a href="#">
                  After 25 years and $185M, Spain’s new Royal Collections Museum
                  is finally opening
                </a>
              </li>
              <li>
                <a href="#">
                  The celebrity who epitomized ‘Barbiecore’ two decades before
                  it had a name
                </a>
              </li>
              <li>
                <a href="#">
                  These joyful photographs of Scouts show a sense of belonging
                  and freedom
                </a>
              </li>
              <li>
                <a href="#">
                  Why the in-flight magazine for an African airline shuttered in
                  2002 is a must-read today
                </a>
              </li>
            </ul>
          </article>
          ...
          <article className="SArticle">
            ...
            />
            <a href="#">
              <b>How Prigozhin’s mutiny will resonate in Russia</b>
            </a>
            <ul>
              <li>
                <a href="#">
                  You might want to rethink taking melatonin as a sleep aid
                </a>
              </li>
              <li>
                <a href="#">It wasn’t like this in Moscow in 1991</a>
              </li>
              <li>
                <a href="#">
                  The Supreme Court rewrites American society once again
                </a>
              </li>
              <li>
                <a href="#">
                  We’re in the midst of anti-sex backlash that has ensnared
                  Jennifer Lawrence’s new romcom
                </a>
              </li>
              <li>
                <a href="#">DeSantis is trying to climb the Trump wall</a>
              </li>
            </ul>
          </article>
        </section>
        ...
        <section id="news6">
          <article className="SArticle">
            ...
            <ul>
              <li>
                <a href="#">
                  DOJ has spent over $9 million investigating Trump since
                  special counsel was appointed
                </a>
              </li>
              <li>
                <a href="#">
                  White House confirms prisoner swap talks with Russia over
                  reporter Evan Gershkovich but so far there’s no ‘clear
                  pathway’
                </a>
              </li>
              <li>
                <a href="#">
                  Biden wants to roll back Trump’s expansion of short-term
          ...
          <article className="SArticle">
            ...
            />
            <a href="#">
              <b>New study: Ancient shrimplike predator was misunderstood</b>
            </a>
            <ul>
              <li>
                <a href="#">
                  Forget TikTok claims: ‘Nature’s Ozempic’ is no such thing,
                  experts say
                </a>
              </li>
              <li>
                <a href="#">Saturn’s rings shine in new Webb telescope photo</a>
              </li>
              <li>
                <a href="#">
          ...
          <article className="SArticle">
            ...
            <a href="#">
              <b>
                Samsung flags massive drop in quarterly profit as chip glut
                drags on
              </b>
            </a>
            <ul>
              <li>
                <a href="#">
                  Twitter threatens to sue Meta after rival app Threads gains
                  traction
                </a>
              </li>
              <li>
                <a href="#">
                  A flying car prototype just got an airworthiness certificate
                  from the FAA
                </a>
              </li>
              <li>
                <a href="#">
                  Meta officially launches Twitter rival Threads. 30 million
                  have joined already
                </a>
              </li>
              <li>
          ...
          <article>
            <ul>
              <li>
                ...
                />
                <a href="#">
                  Extraordinary close-up images show insects as you’ve never
                  seen them before
                </a>
              </li>
              <li>
              ...
              <li>
                ...
                />
                <a href="#">
                  These animals went extinct in the wild. Scientists brought
                  them back
                </a>
              </li>
              <li>
